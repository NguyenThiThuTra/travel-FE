...
export default function ReviewDetailPage() {
  ...
  const review = useSelector(useDataReviewSelector);
  const user = review?.data?.user_id;
        ...
        <div className="review-box">
          <div className="review-box-main">
            ...
            <div className="review-box__content">
              ...
              <ul className="review-box__list-schedule">
                {review &&
                  Object.values(review?.data?.schedule)?.map((day, index) => (
                    <li>
                      {' '}
                      {`Ngày ${index + 1} : `} {day}
                    </li>
            ...
            <div className="review-box__action">
          ...
          <div>
            <Image
              width={350}
              height={250}
              src={review?.data?.images?.[0] || 'error'}
